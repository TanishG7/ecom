...
const ProductDetails = () => {
    ...
    const handleQuantityChange = (e) => {
        if (e === "plus") setSelectedQuantity(selectedQuantity + 1)
        if (e === "minus" && selectedQuantity > 1) setSelectedQuantity(selectedQuantity - 1)
    }
                        ...
                        <div className="mb-4">
                            ...
                            <div className="flex gap-2 mt-2">
                                {selectedProduct.colors.map((color) => (
                                    ...
                                    className={`w-8 h-8 rounded-full border ${selectedColor === color ? "ring-4 ring-black" : "border-gray-300"}`}
